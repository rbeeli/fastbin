...
public:
    static VectorOfVariableSizedStructs create(std::byte* buffer, size_t buffer_size, bool owns_buffer) noexcept
    {
...
{
    os << "[my_models::VectorOfVariableSizedStructs size=" << obj.fastbin_binary_size() << " bytes]\n";
    os << "    values: " << "[vector<struct:ChildVar> count=" << obj.values().size() << "]" << "\n";
