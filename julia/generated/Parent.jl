...
@inline function child1(obj::Parent)::ChildFixed
    ...
    return ChildFixed(ptr, fastbin_child1_size(obj), false)
end
...
@inline function child2(obj::Parent)::ChildVar
    ...
    return ChildVar(ptr, fastbin_child2_size(obj), false)
end
...
@inline function fastbin_child2_size(obj::Parent)::UInt64
    return unsafe_load(reinterpret(Ptr{UInt64}, obj.buffer + fastbin_child2_offset(obj)))
end

@inline function str(obj::Parent)::StringView
    ptr::Ptr{UInt8} = reinterpret(Ptr{UInt8}, obj.buffer + fastbin_str_offset(obj))
    unaligned_size::UInt64 = fastbin_str_size_unaligned(obj)
...
@inline function str!(obj::Parent, value::T) where {T<:AbstractString}
    offset::UInt64 = fastbin_str_offset(obj)
...
@inline function fastbin_str_offset(obj::Parent)::UInt64
    return fastbin_child2_offset(obj) + fastbin_child2_size(obj)
end

@inline function fastbin_str_size(obj::Parent)::UInt64
    stored_size::UInt64 = unsafe_load(reinterpret(Ptr{UInt64}, obj.buffer + fastbin_str_offset(obj)))
    aligned_size::UInt64 = stored_size & 0x00FFFFFFFFFFFFFF
    return aligned_size
end

@inline function fastbin_str_size_unaligned(obj::Parent)::UInt64
    stored_size::UInt64 = unsafe_load(reinterpret(Ptr{UInt64}, obj.buffer + fastbin_str_offset(obj)))
...
@inline function fastbin_compute_binary_size(obj::Parent)::UInt64
    return fastbin_str_offset(obj) + fastbin_str_size(obj)
end
